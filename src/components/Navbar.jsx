  ...
  return (
    <>
      ...
      {showNotifs && (
        ...
        >
          {/* Header */}
          <div className="px-5 py-4 border-b border-white/8 flex-shrink-0" style={{background:'linear-gradient(135deg, rgba(99,102,241,0.1) 0%, rgba(124,58,237,0.06) 100%)'}}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl flex items-center justify-center" style={{background:'rgba(251,146,60,0.15)', border:'1px solid rgba(251,146,60,0.25)'}}>
            ...
            {notifications.length === 0 ? (
              ...
              <div className="p-2 space-y-0.5">
                {notifications.map((n, i) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-8 h-8 rounded-xl flex items-center justify-center mt-0.5" style={{background:'rgba(251,146,60,0.1)', border:'1px solid rgba(251,146,60,0.15)'}}>
          ...
          {/* Footer */}
          {unreadCount > 0 && (
            <div className="px-5 py-3 border-t border-white/5 flex-shrink-0" style={{background:'rgba(255,255,255,0.02)'}}>
              <p className="text-slate-600 text-[11px] text-center">اضغط ✓ على أي إشعار لتحديده كمقروء</p>
            </div>
          )}
        </div>
      )}
