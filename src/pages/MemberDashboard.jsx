...
export default function MemberDashboard() {
  ...
  const [requestForm, setRequestForm] = useState({ title: '', description: '', affected_person: '', priority: 'medium' })
  ...
  async function submitRequest(e) {
    ...
    try {
      ...
      setRequestForm({ title: '', description: '', affected_person: '', priority: 'medium' })
